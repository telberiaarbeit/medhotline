    ...
    <div class="kurse">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12 kurs-title-desktop">

                    <?php

                        if($kurse_hero_title){

                            echo '<h1 class="title-page">'.$kurse_hero_title.'</h1>';
            ...
            <div class="hero-section">
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-6 col-12 left">
                    ...
                    <div class="col-md-3 col-sm-6 col-12 right">
                ...
                <div class="course">
                            ...
                            <?php
                                ...
                                if($course_content){
                                    ...
                                    foreach($course_content as $course_single){
                                        ...
                                        echo '<div class="col-md-4 col-sm-6 col-12"><div class="single-course border-32"><span class="circle"></span><p class="name">'.$course_single['name_course'].'</p></div></div>';
                    ...
                    <div class="date-time">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-12">
                                <a class="btn-get-started" href="<?php if ( !is_user_logged_in() ) { echo $course_register_button_link; } ?>">
                                    <?php 
                        ...
                        <?php
                            ...
                            if($grundkurs_16_course){
                                ...
                                foreach($grundkurs_16_course as $grundkurs_16_single){
                                    ...
                                    echo '<div class="col-md-4 col-sm-6 col-12"><div class="single-course border-32"><span class="circle"></span><p class="name">'.$grundkurs_16_single['name_course_grundkurs_16'].'</p></div></div>';
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            if($kindern_courses){
                                ...
                                foreach($kindern_courses as $kindern_course){

                                    echo '<div class="col-md-4 col-sm-6 col-12"><div class="single-course border-32"><span class="circle"></span><p class="name">'.$kindern_course['name_course_kindern'].'</p></div></div>';
                        ...
                        <?php
                            ...
                            if($diver_courses){
                                ...
                                foreach($diver_courses as $diver_course){
                                    ...
                                    echo '<div class="col-md-4 col-sm-6 col-12"><div class="single-course border-32"><span class="circle"></span><p class="name">'.$diver_course['diver_pack_title'].'</p></div></div>';
