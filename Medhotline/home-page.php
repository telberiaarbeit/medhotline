...
<main id="site-content">
    <div class="hero" style="background-image:url('<?php if($bg_image){ echo $bg_image; }else{ echo $bg_default; } ?>');">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <?php
                    if($faq_title_section){
                        echo '<div class="col-md-12 col-12"><h1 class="title title-main">'.$faq_title_section.'</h1></div>';
                    }
                ?>
            </div>
            <div class="row">
