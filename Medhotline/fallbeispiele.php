                ...
                foreach($case_studies as $case){
                    echo '<div class="row">';
                        echo '<div class="col-lg-5 col-sm-12 col-md-12 col-12">';
                            ...
                            if($case['description']){
                                echo '<div class="content-top mw-440">'.$case['description'].'</div>';
                            }
                        echo '</div>';
