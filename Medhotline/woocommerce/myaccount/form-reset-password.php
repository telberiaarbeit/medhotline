	...
	<div class="row">
		<div class="col-sm-12 col-12">
			...
			<form method="post" class="woocommerce-ResetPassword lost_reset_password">
				...
				<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first new-password">
				...
				<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last new-password">
					<label for="password_2"><?php esc_html_e( 'Neues Kennwort erneut eingeben', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
				...
				<p class="woocommerce-form-row form-row d-block save-password">
					<input type="hidden" name="wc_reset_password" value="true" />
					<button type="submit" class="woocommerce-Button button" value="<?php esc_attr_e( 'Speichern', 'woocommerce' ); ?>"><?php esc_html_e( 'Speichern', 'woocommerce' ); ?></button>
				</p>
